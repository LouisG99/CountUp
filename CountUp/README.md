...
In progress: trying to integrate Firebase to create user accounts --> need to open .xcworksapce file to access project now (won't run properly if open .xcodeproj file)
